  ...
  const sections = [
    {
      ...
      sortOrder: 0,
      content: {
        headline: 'מטפלים מהשורש',
        subheadline: 'מחזירים לנערים ונערות את האמונה בעצמם',
        description: 'חווה למניעת נשירה ואי תפקוד של בני ובנות נוער בגילאי 13-17, באמצעות עבודת אדמה, סדנאות מגוונות, הדרכה הורית וחזרה למסגרת חינוכית',
